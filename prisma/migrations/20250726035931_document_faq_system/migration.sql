...
-- CreateIndex
CREATE INDEX "processed_documents_processing_job_id_idx" ON "processed_documents"("processing_job_id");
...
-- CreateIndex
CREATE INDEX "document_processing_jobs_jobType_idx" ON "document_processing_jobs"("jobType");

-- CreateIndex
CREATE INDEX "document_processing_jobs_created_at_idx" ON "document_processing_jobs"("created_at");

-- CreateIndex
CREATE INDEX "document_processing_jobs_created_by_idx" ON "document_processing_jobs"("created_by");
...
-- AddForeignKey
ALTER TABLE "processed_documents" ADD CONSTRAINT "processed_documents_processing_job_id_fkey" FOREIGN KEY ("processing_job_id") REFERENCES "document_processing_jobs"("id") ON DELETE SET NULL ON UPDATE CASCADE;
